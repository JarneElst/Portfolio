...
<main class="main">
    <section class="row">
        ...
        <article class="projecten-box col-12 col-md-11">
            <h1 class="titel-dark">CHENESSE</h1>
            <figure>
                <img src="./images/Proj-Chenesse.png" alt="Foto Chenesse" class="projecten-picture" />
            </figure>
            <h5 class="titel-dark">Concept</h5>
    ...
    <section class="row">
        ...
        <article class="projecten-box col-12 col-md-11">
            ...
            <figure>
                <img src="./images/Proj-Komiktoneel.png" alt="Logo komiktoneel" class="projecten-picture" />
            </figure>
            ...
            <figure>
                <img src="./images/Proj-komiktoneel-Marlene.png" alt="Persona Marlene" class="projecten-designimg " />
            </figure>
            <figure>
                <img src="./images/proj-komik-pinterest.png" alt="Komiktoneel pinterest" class="projecten-designimg " />
            </figure>
            <p class="projecten-txt">
    ...
    <section class="row">
        ...
        <article class="projecten-box col-12 col-md-11">
            ...
            <figure>
                <img src="./images/proj-olijftak-zorgbedrijfantwerpen.png" alt="Logo olijftak"
    ...
    <section class="row">
        ...
        <article class="projecten-box col-12 col-md-11">
            ...
            <figure>
                <img src="./images/Proj-Grav.png" alt="Foto grav" class="projecten-picture" />
            </figure>
            <h5 class="titel-light">Concept</h5>
            <p class="projecten-txt">
